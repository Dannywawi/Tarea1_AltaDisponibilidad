...
const getReseña = async (req, res) => {
    ...
    const SQLrequest = 'SELECT * FROM reseñas WHERE titulo = $1'
...
const insertReseña = async (req, res) => {
    ...
    const SQLrequest = 'INSERT INTO reseñas(titulo, nombre, resumen) VALUES($1, $2, $3)'
...
const deleteReseña = async (req, res) => {
    ...
    const SQLrequest = 'DELETE FROM reseñas WHERE titulo = $1 '
    const response = await pool.query(SQLrequest, [titulo]);
...
const updateReseña = async (req, res) => {
    ...
    const SQLrequest = 'UPDATE reseñas SET resumen = $3 WHERE titulo = $1 AND nombre = $2'
    const response = await pool.query(SQLrequest, [titulo, autor, review1]);
